...
- **Due Date**: 2/26/26 @ 4:10 PM<!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) then delete this comment -->
...
I decided to use the video game library concept for several reasons. First of all, the video game library was my first and honestly most thought out design, my other designs were really more spaghetti meet wall ideas in general. Second, I have a personal interest in video games already and I feel that having a personal interst in this project would help me focus on it better. And finally, third, it just feels more within the purview of programming, video games are digital and I feel that it meshes the best with it.
