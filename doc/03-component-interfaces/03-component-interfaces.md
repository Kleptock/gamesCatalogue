...
- **Name**: Wesley Lai<!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->
- **Dot Number**: lai.751<!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **Due Date**: 3/10/26 @ 4:10 PM<!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
(i.e., `![ALT TEXT](path/to/file)`).
                              ...
                              Object
                                 |
                              Standard<VideoGameLibrary>
                                 |
                              VideoGameLibraryKernel
                                 |
                              VideoGameLibrary
                                 |
                  --------------------------------
                  |                               |
                  VideoGameLibrary1          VideoGameLibrary
                  (HashMap)                  (BinaryTree)
